...
Across all keywords, words like "myocardial," "perfusion," and "quantification" appear frequently, which shows us the main focus of cardiac MRI research. In "machine learning" abstracts, "myocardial" dominates by a wide margin. "Deep learning" abstracts highlight "coronary" and "strain" quite prominently, which points to a focus on coronary artery imaging and cardiac motion analysis."Artificial intelligence" abstracts focus on "lv" (left ventricle) and "ventricular" function, so AI is might be most often applied to measuring heart chamber performance."Convolution" abstracts stand out with focusing mainly on "perfusion" and "3d" which appear frequently, indicating a focus on blood flow imaging.
::::
...
"Coronary" links to "artery" and "angiography," showing that imaging the coronary arteries is potentially its own distinct research thread separate from the heart muscle work happening on the other side of the graph.
...
jcmr |>
  ...
  scale_fill_gradient(low = "seagreen", high = "darkgreen") +
...
Looking across all of the abstracts, a few terms such as "myocardial," "heart," and "perfusion" come up as the biggest boxes, which shows us the main focus of cardiac MRI research.

"3d," "4d," and "strain" appear prominently, showing that dimensional imaging and motion tracking are very important techniques in how researchers are applying AI to the heart.

Smaller terms like "segmentation," "mapping," and "t1" point to the specific clinical tasks AI is being trained to automate such as outlining structures, measuring tissue properties, and tracking blood flow.

"lv" (left ventricle) and "rv" (right ventricle) stand out as the most studied cardiac structures, since measuring how well the heart pumps is the most important variable to consider in cardiac research. 
::::
